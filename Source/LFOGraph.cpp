...
void LFOGraph::paint (Graphics& g)
{
    ...
    //[UserPaint] Add your own custom painting code here..
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            Point<float> controlPoint1{ c, centrY - height };
            Point<float> controlPoint2{ c, centrY + height };
...
<JUCER_COMPONENT documentType="Component" className="LFOGraph" componentName=""
                 ...
                 fixedSize="1" initialWidth="415" initialHeight="144">
