...
//==============================================================================
OscillatorComponent::OscillatorComponent (MooderAudioProcessor& p)
    : processor(p)
{
...
void OscillatorComponent::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    if (sliderThatWasMoved == octaveSlider.get())
    {
        ...
        processor.setParameterNotifyingHost(0, (sliderThatWasMoved->getValue() + 3)/6);
    ...
    else if (sliderThatWasMoved == transSlider.get())
    {
        ...
        processor.setParameterNotifyingHost(1, (sliderThatWasMoved->getValue() + 12) / 24);
    ...
    else if (sliderThatWasMoved == tuneSlider.get())
    {
        ...
        processor.setParameterNotifyingHost(2, (sliderThatWasMoved->getValue() + 1) / 2);
    ...
    else if (sliderThatWasMoved == levelSlider.get())
    {
        ...
        processor.setParameterNotifyingHost(3, sliderThatWasMoved->getValue());
...
void OscillatorComponent::buttonClicked (Button* buttonThatWasClicked)
{
